...
const menuBurger: MenuItem = {
  id: "classic-cheeseburger", restaurantId: "burger-lab",
  name: "Classic Cheeseburger",
  description: "Beef patty, melted cheddar, lettuce, tomato, house sauce on a brioche bun.",
  priceCents: 7200, image: px(IMG.burgerItem),
  prepTimeMinutes: 12, calories: 650, dietaryTags: [], isPopular: true,
  category: "Burgers", rating: 4.8, popularityCount: 1240,
};

const menuVeganBurger: MenuItem = {
  id: "plant-power-burger", restaurantId: "burger-lab",
  name: "Plant Power Burger",
  description: "Beyond patty, vegan cheese, rocket, caramelised onion, vegan mayo.",
  priceCents: 8400, image: px(IMG.veganBurger),
  prepTimeMinutes: 14, calories: 480, dietaryTags: ["Vegan", "Halal"],
  isPopular: true, category: "Burgers", rating: 4.6, popularityCount: 890,
};

const menuFries: MenuItem = {
  id: "truffle-fries", restaurantId: "burger-lab",
  name: "Truffle Parmesan Fries",
  description: "Hand-cut fries tossed in truffle oil and parmesan.",
  priceCents: 3800, image: px(IMG.fries),
  prepTimeMinutes: 8, calories: 420, dietaryTags: ["Vegetarian"],
  isPopular: false, category: "Sides", rating: 4.7, popularityCount: 2100,
};

const menuShake: MenuItem = {
  id: "chocolate-shake", restaurantId: "burger-lab",
  name: "Belgian Chocolate Shake",
  description: "Thick chocolate shake with whipped cream and dark cocoa shards.",
  priceCents: 4500, image: px(IMG.shake),
  prepTimeMinutes: 5, calories: 520, dietaryTags: ["Vegetarian"],
  isPopular: true, category: "Drinks", rating: 4.9, popularityCount: 1800,
};

const menuPizzaMargherita: MenuItem = {
  id: "margherita-pizza", restaurantId: "pizza-studio",
  name: "Margherita Pizza",
  description: "San Marzano tomato, fresh mozzarella, basil, extra virgin olive oil.",
  priceCents: 9500, image: px(IMG.pizzaMargherita),
  prepTimeMinutes: 18, calories: 850, dietaryTags: ["Vegetarian"],
  isPopular: true, category: "Pizzas", rating: 4.8, popularityCount: 1560,
};

const menuPizzaPepperoni: MenuItem = {
  id: "pepperoni-pizza", restaurantId: "pizza-studio",
  name: "Pepperoni Pizza",
  description: "Double pepperoni, mozzarella, tomato base, chili oil drizzle.",
  priceCents: 10800, image: px(IMG.pizzaPepperoni),
  prepTimeMinutes: 18, calories: 980, dietaryTags: ["Spicy"],
  isPopular: true, category: "Pizzas", rating: 4.7, popularityCount: 1320,
};

const menuBowlHarvest: MenuItem = {
  id: "harvest-bowl", restaurantId: "greenhouse-deli",
  name: "Harvest Bowl",
  description: "Quinoa, roasted sweet potato, chickpeas, kale, tahini dressing.",
  priceCents: 8600, image: px(IMG.harvestBowl),
  prepTimeMinutes: 10, calories: 540, dietaryTags: ["Vegan", "Gluten-Free"],
  isPopular: true, category: "Bowls", rating: 4.9, popularityCount: 980,
};

const menuSmoothie: MenuItem = {
  id: "green-glow-smoothie", restaurantId: "greenhouse-deli",
  name: "Green Glow Smoothie",
  description: "Spinach, banana, mango, ginger, flax seed, almond milk.",
  priceCents: 4200, image: px(IMG.smoothie),
  prepTimeMinutes: 5, calories: 280, dietaryTags: ["Vegan", "Gluten-Free"],
  isPopular: true, category: "Smoothies", rating: 4.7, popularityCount: 750,
};

const menuCoffee: MenuItem = {
  id: "flat-white", restaurantId: "brew-lab",
  name: "Flat White",
  description: "Double ristretto, velvety steamed milk, micro-foam.",
  priceCents: 2800, image: px(IMG.coffee),
  prepTimeMinutes: 4, calories: 120, dietaryTags: ["Vegetarian"],
  isPopular: true, category: "Coffee", rating: 4.8, popularityCount: 3200,
};

const menuCroissant: MenuItem = {
  id: "butter-croissant", restaurantId: "brew-lab",
  name: "Butter Croissant",
  description: "Flaky, buttery, baked fresh daily. Best paired with a flat white.",
  priceCents: 2500, image: px(IMG.croissant),
  prepTimeMinutes: 3, calories: 270, dietaryTags: ["Vegetarian"],
  isPopular: false, category: "Pastries", rating: 4.6, popularityCount: 1100,
};

const menuSushiRoll: MenuItem = {
  id: "dragon-roll", restaurantId: "sushi-sensei",
  name: "Dragon Roll",
  description: "Eel, cucumber, avocado on top, tobiko, eel sauce drizzle.",
  priceCents: 11200, image: px(IMG.sushiRoll),
  prepTimeMinutes: 15, calories: 480, dietaryTags: [],
  isPopular: true, category: "Sushi", rating: 4.9, popularityCount: 670,
};

const menuRamen: MenuItem = {
  id: "tonkotsu-ramen", restaurantId: "noodle-house",
  name: "Tonkotsu Ramen",
  description: "Rich pork bone broth, chashu, soft egg, green onion, nori.",
  priceCents: 9800, image: px(IMG.ramen),
  prepTimeMinutes: 20, calories: 720, dietaryTags: ["Spicy"],
  isPopular: true, category: "Ramen", rating: 4.8, popularityCount: 890,
};

export const restaurants: Restaurant[] = [
  {
    id: "burger-lab", name: "Burger Lab", cuisine: "Burgers · Shakes",
    heroImage: px(IMG.burgerHero, 800, 500), logoImage: px(IMG.burgerItem, 100, 100),
    rating: 4.8, reviewCount: 320, etaMinutes: 18, distance: "0.4 km",
    discountLabel: "15% Student", studentDiscountPercent: 15,
    categories: ["Burgers", "Sides", "Drinks"], isOpen: true,
    openingHours: [
  ...
  {
    id: "pizza-studio", name: "Pizza Studio", cuisine: "Pizza · Italian",
    heroImage: px(IMG.pizzaHero, 800, 500),
    rating: 4.7, reviewCount: 210, etaMinutes: 22, distance: "0.7 km",
    discountLabel: "20% Student", studentDiscountPercent: 20,
    categories: ["Pizzas"], isOpen: true,
    openingHours: [
  ...
  {
    id: "greenhouse-deli", name: "Greenhouse Deli", cuisine: "Bowls · Smoothies",
    heroImage: px(IMG.greenhouseHero, 800, 500),
    rating: 4.9, reviewCount: 180, etaMinutes: 12, distance: "0.2 km",
    discountLabel: "10% Student", studentDiscountPercent: 10,
    categories: ["Bowls", "Smoothies"], isOpen: true,
    openingHours: [
  ...
  {
    id: "brew-lab", name: "Brew Lab Coffee", cuisine: "Coffee · Pastries",
    heroImage: px(IMG.brewHero, 800, 500),
    rating: 4.8, reviewCount: 410, etaMinutes: 8, distance: "0.1 km",
    discountLabel: "Free Upgrade", studentDiscountPercent: 0,
    categories: ["Coffee", "Pastries"], isOpen: true,
    openingHours: [
  ...
  {
    id: "sushi-sensei", name: "Sushi Sensei", cuisine: "Sushi · Japanese",
    heroImage: px(IMG.sushiHero, 800, 500),
    rating: 4.9, reviewCount: 150, etaMinutes: 25, distance: "1.1 km",
    discountLabel: "15% Student", studentDiscountPercent: 15,
    categories: ["Sushi"], isOpen: false,
    openingHours: [{ day: "Mon–Sun", hours: "12:00 – 21:00" }],
    tags: ["Premium"],
    reviews: [
  ...
  {
    id: "noodle-house", name: "Noodle House", cuisine: "Ramen · Asian",
    heroImage: px(IMG.noodleHero, 800, 500),
    rating: 4.7, reviewCount: 260, etaMinutes: 20, distance: "0.5 km",
    discountLabel: "12% Student", studentDiscountPercent: 12,
    categories: ["Ramen"], isOpen: true,
...
export const offers: Offer[] = [
  {
    id: "offer-1", title: "Free coffee with any breakfast",
    description: "Order before 9 AM and get a free flat white.",
    restaurantName: "Brew Lab Coffee", discountPercent: 100,
    expiryDate: "2026-08-15", image: px(IMG.brewHero, 400, 250),
    isStudentExclusive: true,
  },
  {
    id: "offer-2", title: "20% off all pizzas",
    description: "Student-only discount on all pizzas every Thursday.",
    restaurantName: "Pizza Studio", discountPercent: 20,
    expiryDate: "2026-08-31", image: px(IMG.pizzaHero, 400, 250),
    isStudentExclusive: true,
  },
  {
    id: "offer-3", title: "Buy one get one free smoothie",
    description: "Valid on all smoothies during exam season.",
    restaurantName: "Greenhouse Deli", discountPercent: 50,
    expiryDate: "2026-08-10", image: px(IMG.greenhouseHero, 400, 250),
    isStudentExclusive: true,
  },
];
